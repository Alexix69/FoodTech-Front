...
export function BarView() {
  ...
  return (
    ...
    >
      {error && (
        <div data-testid="bar-error" className="mx-10 mt-6 bg-red-500/10 border border-red-500/20 rounded-xl p-4">
      ...
      {loading && pendingTasks.length === 0 && inPrepTasks.length === 0 ? (
        <div data-testid="bar-loading" className="flex items-center justify-center min-h-[400px]">
